...
<div class="am-cf admin-main">
      ...
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
         ...
         <li><a href="${pageContext.request.contextPath}/Task/getBitTasksList.do"><span class="am-icon-puzzle-piece"></span> 竞标审核</a></li>
           <li><a href="${pageContext.request.contextPath}/Task/getDoneTasksList.do"><span class="am-icon-bug"></span> 任务结果审核</a></li>
        </ul>
      </li>
    </ul>
  ...
  <div class="admin-content">
     <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">当前有${newUsersList.size()}个新用户申请注册</strong> </div>
    </div>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-check"><input type="checkbox" /></th><th class="table-id">ID</th><th class="table-type">用户名</th><th class="table-date">注册日期</th><th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
          		<%-- c:forEach一定要加jstl声明。begin-end长度大于列表长度时，以列表长度为最大值；end-begin+1等于元素个数 --%>
             	<c:forEach var = "i" varStatus = "v" items = "${newUsersList }" begin = "0" end = "${newUsersList.size()-1 }">
             		<tr>
			               <td><input type="checkbox" /></td>
			              <td>${i.userId }</td>
			              <td><a href="${pageContext.request.contextPath}/User/showNewUserDetails.do?userId=${i.userId }&userName=${i.userName}&password=${i.password}&name=${i.name}&phoneNumber=${i.phoneNumber}&alipayId=${i.alipayId}&alipayName=${i.alipayName}&personalIntroduction=${i.personalIntroduction}">${i.userName }</a></td>
			              <td>2018年3月10日 7:28:47</td>
			              <td>
			                <div class="am-btn-toolbar">
			                  <div class="am-btn-group am-btn-group-xs">
			                    <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 同意</button>
			                    <button class="am-btn am-btn-default am-btn-xs"><span class="am-icon-copy"></span> 拒绝</button>
